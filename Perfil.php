...
if($_SESSION['login']==0){header('Location: ./Main.php');}
...
<header >
<?php include("php/modprofile.php");?>
...
<div ><input style="width: 35rem" placeholder="New User" tabindex="10" type="User" value="" name="changeUser" id="user"></input></div>
<div><input <?php if ($_SESSION['login']==0){ echo 'style="display:none;"'; } ?> class="button button-support small expanded" tabindex="1" title="Nuevo Usuario" value= "Change Username" type="submit" name="moduser">
</input></div>
</div></br>
<div>
<label>Change Password:</label></br>
<label>Old Password:</label></br>
<input style="width: 35rem" autocomplete="off" placeholder="Old Password" tabindex="2" type="password" name="changeUser4" id="user_pwd1">
<label>New Password:</label></br>
<input style="width: 35rem" autocomplete="off" placeholder="New Password" tabindex="2" type="password" name="changeUser5" id="user_pwd2">
<label>Repeat New Password:</label></br>
<input style="width: 35rem" autocomplete="off" placeholder="New Password" tabindex="2" type="password" name="changeUser6" id="user_pwd3">
<input class="button button-support small expanded" title="Change Password" value= "Change Password" type="submit" name="modpwd">
</input>
</div>
</br>
<div>
...
<input style="width: 35rem" placeholder="Old Email" tabindex="1" type="email" value="" name="changeUser1" id="user_email1">
<label>New Email:</label></br>
<input style="width: 35rem" placeholder="New Email" tabindex="1" type="email" value="" name="changeUser2" id="user_email2">
<label>Repeat New Email:</label></br>
<input style="width: 35rem" autocomplete="off" placeholder="New Email" tabindex="1" type="email" value="" name="changeUser3" id="user_email3">
<input class="button button-support small expanded" title="Apoyar esta propuesta" value= "Change Email" type="submit" name="modemail">
</input>
</div>
</div>
</form>
