	...
	if (is_string($_GET["pagina"])) {
		...
		//Si la string es numérica, define la variable 'pagina'
		 if (is_numeric($_GET["pagina"])) {
			 ...
			 if ($_GET["pagina"] == 1) {
				 header("Location: PropTopNew.php");
				 die();
...
<main>
  <div class="wrap row">
    ...
    <a class="" href="./PropuestasCiudadanas.php">Most Commented</a>
    <a class="" href="./PropTopVot.php">Most Supported</a>
    <a class="active" href="./PropTopNew.php">News Proposals</a>
</section>
...
FROM propuestas ORDER BY Fecha_Creacion DESC
