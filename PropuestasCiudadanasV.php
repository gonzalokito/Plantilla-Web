	...
	if (is_string($_GET["pagina"])) {
		...
		//Si la string es numérica, define la variable 'pagina'
		 if (is_numeric($_GET["pagina"])) {
			 ...
			 if ($_GET["pagina"] == 1) {
				 header("Location: PropuestasCiudadanasV.php");
				 die();
...
<html lang="es" data-current-user-id="" class="turbolinks-progress-bar"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
 ...
 <div class="row">
  ...
  <ul>
    ...
    <li>
      <a accesskey="v" style="color:blue" href="./PropuestasCiudadanasV.php">Vote</a>
    </li>
  </ul>
</div>
...
<main>
  <div class="wrap row">
    ...
    <a class="active" href="./PropuestasCiudadanasV.php">Confirmed Proposals</a>
</section>
...
$obtener_todo_BD = "SELECT * FROM propuestas WHERE Confirmacion=1";
...
FROM propuestas WHERE Confirmacion=1 ORDER BY N_Comentarios DESC
